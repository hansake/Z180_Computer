/*  z180sd.h
 *
 *  Defines SD card structures and routines for
 *  my DIY Z180 Computer.
 *
...
/* Where uploader and test code is loaded and executing
 * should really be defined in the Makefile
 */
...
#define INITFLG 0xfefe     /* Address of the byte where the SD init ok flag is stored */
#define SEBYFLG 0xfeff     /* Address of the byte where the SD block address multiplier flag is stored */
